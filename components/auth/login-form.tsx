...
export function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const user: User | null = findUserByCredentials(email, password);
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-8 shadow-sm">
      ...
      {/* Demo hint */}
      <div className="mt-4 rounded-lg bg-secondary p-3 text-xs text-muted-foreground space-y-0.5">
        <p className="font-semibold text-foreground">Credenciales de demo</p>
        <p>Admin → mateo@gmail.com / admin123</p>
        <p>Participante → sofia@gmail.com / sofia123</p>
      </div>
    </div>
  );
}
